      ...
      <div className="relative z-10 w-full h-full flex items-center justify-center px-8">
        <div className="w-full max-w-6xl flex items-center gap-16">
          ...
          >
            ...
            >
              Access powerful analytics and insights with enterprise-grade
              security. Your data-driven decisions start here.
            </p>
            ...
            <form onSubmit={handleLogin}>
                ...
                <div style={{ position: "relative" }}>
                  <div
                    style={{
                      ...
                      color:
                        focusedField === "username" ? "#3B82F6" : "#9CA3AF",
                      display: "flex",
                      alignItems: "center",
                  ...
                  <input
                    ...
                    style={{
                      ...
                      border: `2px solid ${focusedField === "username" ? "#3B82F6" : "#E5E7EB"}`,
                      borderRadius: "14px",
                      outline: "none",
                      transition: "all 0.3s",
                      boxShadow:
                ...
                <div style={{ position: "relative" }}>
                  <div
                    style={{
                      ...
                      transform: "translateY(-50%)",
                      color:
                        focusedField === "password" ? "#3B82F6" : "#9CA3AF",
                      display: "flex",
                      alignItems: "center",
                      transition: "color 0.3s",
                      zIndex: 1,
                  ...
                  <input
                    ...
                    style={{
                      ...
                      color: "#1a1a2e",
                      backgroundColor: "white",
                      border: `2px solid ${focusedField === "password" ? "#3B82F6" : "#E5E7EB"}`,
                      borderRadius: "14px",
                      outline: "none",
                      transition: "all 0.3s",
                      boxShadow:
              ...
              >
                ...
                <a
                  ...
                  onMouseEnter={(e) =>
                    (e.currentTarget.style.color = "#8b3dff")
                  }
                  onMouseLeave={(e) =>
                    (e.currentTarget.style.color = "#3B82F6")
                  }
