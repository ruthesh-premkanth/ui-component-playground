    ...
    >
      ...
      <Modal isOpen={openModal === 7} onClose={() => setOpenModal(null)}>
        ...
        >
          ...
          <div style={{ padding: "24px" }}>
            ...
            >
              This is a large modal with more space for content. You can add
              forms, tables, or any other content here.
            </p>
            <p
              style={{
                fontSize: "14px",
      ...
      <Modal isOpen={openModal === 8} onClose={() => setOpenModal(null)}>
        ...
        >
          ...
          <p
            style={{ fontSize: "13px", color: "#6B7280", margin: "0 0 20px 0" }}
          >
      ...
      {openModal === 12 && (
        ...
        >
          ...
          <div style={{ padding: "24px", maxWidth: "800px", margin: "0 auto" }}>
            ...
            >
              This modal takes up the entire screen. Perfect for complex forms
              or detailed content.
            </p>
          </div>
        </div>
