        ...
        {tabs.map((tab, idx) => (
          <button
            ...
            style={{
              ...
              border: "none",
              borderBottom:
                active === idx ? "3px solid #3B82F6" : "3px solid transparent",
              cursor: "pointer",
              transition: "all 0.3s",
              marginBottom: "-2px",
            }}
        ...
        {tabs.map((tab, idx) => (
          <button
            ...
            style={{
              ...
              transition: "all 0.3s",
              boxShadow:
                active === idx ? "0 2px 8px rgba(105, 0, 239, 0.3)" : "none",
            }}
          >
            {tab}
          </button>
        ...
        {tabs.map((tab, idx) => (
          <button
            ...
            style={{
              ...
              border:
                active === idx ? "2px solid #3B82F6" : "2px solid #e5e7eb",
              borderRadius: "8px",
              cursor: "pointer",
              transition: "all 0.3s",
            }}
        ...
        {tabs.map((tab, idx) => (
          <button
            ...
            style={{
              ...
              transition: "all 0.3s",
              boxShadow:
                active === idx ? "0 4px 12px rgba(105, 0, 239, 0.3)" : "none",
            }}
          >
            {tab}
          </button>
          ...
          return (
            <button
              ...
              style={{
                ...
                textAlign: "left",
                boxShadow:
                  active === idx ? "0 2px 8px rgba(0,0,0,0.08)" : "none",
              }}
            >
              <Icon size={18} />
              {tab.label}
        ...
        {tabs.map((tab, idx) => (
          <button
            ...
            style={{
              ...
              transition: "all 0.3s",
              boxShadow:
                active === idx ? "0 -2px 8px rgba(0,0,0,0.05)" : "none",
            }}
          >
            {tab}
          </button>
